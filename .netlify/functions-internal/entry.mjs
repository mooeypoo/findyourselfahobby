...
import { reactive, computed, watchEffect, toRefs, capitalize, getCurrentInstance as getCurrentInstance$1, watch, onScopeDispose, effectScope, shallowRef, defineComponent as defineComponent$1, camelize, h, ref, inject as inject$1, unref, provide, createVNode, mergeProps, isRef, toRaw, onBeforeUnmount, readonly, onDeactivated, onActivated, onMounted, nextTick, TransitionGroup, Transition, onBeforeMount, withDirectives, Fragment, resolveDirective, vShow, toRef, Text, resolveDynamicComponent, cloneVNode, warn, toHandlers, Teleport, createTextVNode, onBeforeUpdate, vModelText, createSSRApp } from 'vue';
import { renderToString } from 'vue/server-renderer';
/* empty css                                  */import { s as server_default, g as deserializeManifest } from './chunks/astro.43588f80.mjs';
import { _ as _page0 } from './chunks/pages/all.6f0b43a1.mjs';
import 'mime';
import 'cookie';
import 'html-escaper';
import 'kleur/colors';
 ...
 */
const StaticHtml = defineComponent$1({
	props: {
		value: String,
		name: String,
	},
...
const _manifest = Object.assign(deserializeManifest({"adapterName":"@astrojs/netlify/functions","routes":[{"file":"","links":["_astro/index.a18e954a.css"],"scripts":[],"routeData":{"route":"/","type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","_meta":{"trailingSlash":"ignore"}}}],"base":"/","markdown":{"drafts":false,"syntaxHighlight":"shiki","shikiConfig":{"langs":[],"theme":"github-dark","wrap":false},"remarkPlugins":[],"rehypePlugins":[],"remarkRehype":{},"gfm":true,"smartypants":true,"contentDir":"file:///home/moriel/code/projects/findyourselfahobby/src/content/"},"pageMap":null,"propagation":[["/home/moriel/code/projects/findyourselfahobby/src/layouts/Layout.astro","in-tree"],["/home/moriel/code/projects/findyourselfahobby/src/pages/index.astro","in-tree"],["/home/moriel/code/projects/findyourselfahobby/src/pages/index.astro?astro&type=style&index=0&lang.css","in-tree"]],"renderers":[],"entryModules":{"\u0000@astrojs-ssr-virtual-entry":"_@astrojs-ssr-virtual-entry.mjs","@astrojs/vue/client.js":"_astro/client.a4b2bfff.js","astro:scripts/before-hydration.js":""},"assets":["/_astro/index.a18e954a.css","/_astro/server.73841156.css","/favicon.svg","/_astro/client.a4b2bfff.js"]}), {
	pageMap: pageMap,
	renderers: renderers
});
const _args = {};
